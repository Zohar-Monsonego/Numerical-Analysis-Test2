...
from matrix_utility import swap_rows_elementary_matrix, row_addition_elementary_matrix, partial_pivoting
...
def lu_solve(A_b):
    ...
    U2 = U[:, :-1]
    mult_mat = np.dot(L, U2)
    print("LU = " + str(mult_mat))
    mat_mult_vector = np.dot(mult_mat, result)
    print("LUx = " + str(mat_mult_vector))
